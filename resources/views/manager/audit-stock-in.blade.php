...
<div class="max-w-7xl mx-auto px-6 py-8">
    <h1 class="text-2xl font-bold mb-4">Audit Barang Masuk</h1>
    ...
    <div class="mb-6">
    <a href="{{ route('manager.audit.in.pdf', request()->only(['from', 'to'])) }}"
       target="_blank"
    ...
    <div class="overflow-x-auto bg-white shadow rounded">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="text-sm text-gray-800 divide-y divide-gray-100">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center text-gray-500 px-4 py-4">Tidak ada data barang masuk.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
