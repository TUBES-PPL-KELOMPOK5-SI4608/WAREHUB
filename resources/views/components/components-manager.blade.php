@include('components.components-manager')
...
<body class="bg-[#FBFAF5] text-gray-800">
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-[#74512D] text-white flex flex-col p-4">
            ...
            <nav class="space-y-2">
                <a href="{{ route('dashboard-manager') }}" class="block py-2 px-4 rounded hover:bg-[#FEBA17] {{ request()->is('dashboard-manager') ? 'bg-[#FEBA17]' : '' }}">
                    🏠 Dashboard
                </a>
